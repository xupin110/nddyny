...
$config['server']['set'] = [
    ...
    'worker_num' => config_get('server.set.worker_num'),    //worker process num
    'backlog' => 128,   //listen backlog
    'open_tcp_nodelay' => 1,
    'dispatch_mode' => 2,
    'task_worker_num' => config_get('server.set.task_worker_num'),
...
$config['allow_ServerController'] = config_get('allow_ServerController');
return $config;